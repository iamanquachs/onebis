...
(function () {
  var imageDialog = function (editor, dialogType) {
      ...
      if (dialog.lockRatio) {
        ...
        if (oImageOriginal.getCustomData("isReady") == "true") {
          if (this.id == "txtHeight") {
            if (value && value != "0")
              value = Math.round(
                oImageOriginal.$.width * (value / oImageOriginal.$.height)
              );
            if (!isNaN(value)) dialog.setValueOf("info", "txtWidth", value);
          }
          // this.id = txtWidth.
          else {
            if (value && value != "0")
              value = Math.round(
                oImageOriginal.$.height * (value / oImageOriginal.$.width)
              );
            if (!isNaN(value)) dialog.setValueOf("info", "txtHeight", value);
          }
        }
      }
    ...
    function commitContent() {
      var args = arguments;
      var inlineStyleField = this.getContentElement(
        "advanced",
        "txtdlgGenStyle"
      );
    ...
    function commitInternally(targetFields) {
      ...
      if (element) {
        ...
        for (var i = 0; i < length; i++) {
          field = dialog.getContentElement.apply(
            dialog,
            targetFields[i].split(":")
          );
          // May cause recursion.
    ...
    var switchLockRatio = function (dialog, value) {
      ...
      if (value == "check") {
        if (
          ...
          if (!width && !height) {
            ...
            var ratioComparison =
              Math.round((originalRatio / thisRatio) * 100) / 100;
      ...
      if (dialog.lockRatio) ratioButton.removeClass("cke_btn_unlocked");
      else ratioButton.addClass("cke_btn_unlocked");
    ...
    var onImgLoadErrorEvent = function () {
      ...
      if (this.preview) this.preview.setAttribute("src", noimage);
    ...
    return {
      ...
      minWidth:
        (CKEDITOR.skinName || editor.config.skin) == "moono-lisa" ? 500 : 420,
      minHeight: 360,
      ...
      onShow: function () {
        ...
        if (link) {
          ...
          if (linkChildren.count() == 1) {
            ...
            if (childTag.type == CKEDITOR.NODE_ELEMENT) {
              if (childTag.is("img") || childTag.is("input")) {
                ...
                if (this.imageElement.is("img")) this.imageEditMode = "img";
          ...
          // Fill out all fields.
          if (dialogType == "image") this.setupContent(LINK, link);
        }
      ...
      onOk: function () {
        ...
        if (this.imageEditMode) {
          ...
          if (
            dialogType == "image" &&
            imgTagName == "input" &&
            confirm(editor.lang.image.button2Img)
          ) {
            // jshint ignore:line
            // Replace INPUT-> IMG
            imgTagName = "img";
          ...
          // ImageButton dialog and Image element.
            ...
            dialogType != "image" &&
            imgTagName == "img" &&
            confirm(editor.lang.image.img2Button)
          ) {
            // jshint ignore:line
            // Replace IMG -> INPUT
            imgTagName = "input";
      ...
      onLoad: function () {
        if (dialogType != "image") this.hidePage("Link"); //Hide Link tab.
      ...
      contents: [
        {
          ...
          elements: [
                  ...
                  children: [
                    {
                      ...
                      onChange: function () {
                        ...
                        if (newUrl.length > 0) {
                          ...
                          // Show loader.
                          var loader =
                            CKEDITOR.document.getById(imagePreviewLoaderId);
                          ...
                          if (dialog.preview) {
                            ...
                            dialog.preview.setAttribute(
                              "src",
                              previewPreloader.$.src
                            );
                            updatePreview(dialog);
                          }
                        }
            ...
            },
            {
              ...
              setup: function (type, element) {
                if (type == IMAGE) this.setValue(element.getAttribute("alt"));
              },
              commit: function (type, element) {
                if (type == IMAGE) {
                      ...
                      children: [
                          ...
                          children: [
                            {
                              ...
                              validate: function () {
                                ...
                                if (!isValid)
                                  alert(
                                    editor.lang.common.invalidLength
                                      .replace("%1", editor.lang.common.width)
                                      .replace("%2", "px, %")
                                  ); // jshint ignore:line
                                return isValid;
                              },
                              ...
                              commit: function (type, element) {
                                ...
                                if (type == IMAGE) {
                                  ...
                                  if (!aMatch) {
                                    ...
                                    if (
                                      oImageOriginal.getCustomData("isReady") ==
                                      "true"
                                    )
                                      element.setStyle(
                                        "width",
                                        oImageOriginal.$.width + "px"
                                      );
                                  } else {
                                    element.setStyle(
                                      "width",
                            ...
                            },
                            {
                              ...
                              validate: function () {
                                ...
                                if (!isValid)
                                  alert(
                                    editor.lang.common.invalidLength
                                      .replace("%1", editor.lang.common.height)
                                      .replace("%2", "px, %")
                                  ); // jshint ignore:line
                                return isValid;
                              },
                        ...
                        },
                        {
                          ...
                          onLoad: function () {
                            ...
                            var resetButton =
                                CKEDITOR.document.getById(btnResetSizeId),
                              ratioButton =
                                CKEDITOR.document.getById(btnLockSizesId);
                            if (resetButton) {
                              resetButton.on(
                                "click",
                                function (evt) {
                              ...
                              ratioButton.on(
                                ...
                                function (evt) {
                                  ...
                                  if (
                                    ...
                                    var height =
                                      (oImageOriginal.$.height /
                                        oImageOriginal.$.width) *
                                      width;
                                    if (!isNaN(height)) {
                                      this.setValueOf(
                                        "info",
                      ...
                      children: [
                        {
                          ...
                          validate: CKEDITOR.dialog.validate.integer(
                            editor.lang.image.validateBorder
                          ),
                          setup: function (type, element) {
                            if (type == IMAGE) {
                              var value,
                              ...
                              borderStyle =
                                borderStyle &&
                                borderStyle.match(/^(\d+px)(?: \1 \1 \1)?$/);
                              value =
                                borderStyle && parseInt(borderStyle[1], 10);
                          ...
                          setup: function (type, element) {
                            if (type == IMAGE) {
                              var value,
                                ...
                                marginRightPx,
                                marginLeftStyle =
                                  element.getStyle("margin-left"),
                                marginRightStyle =
                                  element.getStyle("margin-right");

                              marginLeftStyle =
                                marginLeftStyle &&
                                marginLeftStyle.match(pxLengthRegex);
                              marginRightStyle =
                                marginRightStyle &&
                                marginRightStyle.match(pxLengthRegex);
                              marginLeftPx = parseInt(marginLeftStyle, 10);
                              marginRightPx = parseInt(marginRightStyle, 10);

                              value =
                                marginLeftPx == marginRightPx && marginLeftPx;
                              isNaN(parseInt(value, 10)) &&
                          ...
                          setup: function (type, element) {
                            if (type == IMAGE) {
                              var value,
                                ...
                                marginBottomStyle =
                                  element.getStyle("margin-bottom");

                              marginTopStyle =
                                marginTopStyle &&
                                marginTopStyle.match(pxLengthRegex);
                              marginBottomStyle =
                                marginBottomStyle &&
                                marginBottomStyle.match(pxLengthRegex);
                              marginTopPx = parseInt(marginTopStyle, 10);
                              marginBottomPx = parseInt(marginBottomStyle, 10);

                              value =
                                marginTopPx == marginBottomPx && marginTopPx;
                              isNaN(parseInt(value, 10)) &&
                        ...
                        },
                        {
                          ...
                          commit: function (type, element) {
                            var value = this.getValue();
                            if (type == IMAGE || type == PREVIEW) {
                              if (value) element.setStyle("float", value);
          ...
          elements: [
            {
              ...
              setup: function (type, element) {
                if (type == LINK) {
                  ...
                  if (!href) href = element.getAttribute("href");
                  this.setValue(href);
                }
              },
              commit: function (type, element) {
                if (type == LINK) {
                  if (this.getValue() || this.isChanged()) {
                    ...
                    if (
                      this.getValue() ||
                      !editor.config.image_removeLinkByEmptyURL
                    )
                      this.getDialog().addLink = true;
                    else this.getDialog().addLink = false;
                  }
                }
              },
            },
          ...
          elements: [
            ...
            },
            {
              ...
              validate: CKEDITOR.dialog.validate.inlineStyle(
                editor.lang.common.invalidInlineStyle
              ),
              default: "",
              setup: function (type, element) {
                if (type == IMAGE) {
