                ...
                <div class="">
                    <div class="flex justify-between px-3 py-2 items-center  border-b border-[#ffffff40]">
                        <div class="flex gap-5   items-center ">
                            <p class="text-lg text-[#83ff00]">Ví khách hàng</p>
                        </div>
                        <div class="flex gap-5 items-center">
                            <button type="button" id="btn_add" onclick="open_modal('form_add_member')" class="bg-[#008d3f] border-none px-5 py-2 text-white rounded-md">Thêm ví </button>
                        </div>
                    </div>
                    ...
                    <table class=" min-w-full">
                        <thead>
                            <tr class="text-[#efbff5] text-lg">
                                ...
                                <th class=" px-4 py-2 text-start font-thin">Tên ví</th>
        ...
        <div class="flex min-h-full justify-center p-4 text-center items-center sm:p-0">
            ...
            <div id="kichthuoc_form" class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full max-w-xl">
                <div class="bg-white">
                    <div class="flex flex-shrink-0 items-center justify-between rounded-t-md border-b-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50">
                        ...
                        <h5 class="text-xl font-medium leading-normal !text-[green]" id="exampleModalLabel">
                            Thêm ví <span class='tenphanloai_btn lowercase'></span>
                        </h5>
                        <!--Close button-->
                    ...
                    <div class="p-4  " data-te-modal-body-ref>
                        <div class="grid grid-cols-12 w-full justify-between items-center py-3 ">
                            <p class="col-span-3  text-[black]">Tên ví</p>
                        ...
                        <div class="grid grid-cols-12 w-full justify-between items-center py-3 gap-3">
                            <p class="col-span-3  text-[red] text-xl">Số tiền từ</p>
                            ...
                            <p class="col-span-2  text-[red] text-xl">Đến < </p>
                ...
                <div id='footer_thongbao' class="bg-gray-50 px-4 py-3 flex justify-end gap-3">
                    <button type="button" id='btn_chi' onclick="add_member('GNT')" class="mt-3 inline-flex w-full justify-center rounded-md bg-green-600 px-7 py-2 text-[14px]  text-white shadow-sm t ring-gray-300 hover:bg-[green]  sm:mt-0 max-w-[100px] ">Lưu</button>
        ...
        <div class="flex min-h-full justify-center p-4 text-center items-center sm:p-0">
            ...
            <div id="kichthuoc_form" class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full max-w-xl">
                <div class="bg-white">
                    ...
                    <div class="p-4  " data-te-modal-body-ref>
                        <div class="grid grid-cols-12 w-full justify-between items-center py-3 ">
                            <p class="col-span-3  text-[black]">Tên nhóm</p>
                            <div class="col-span-9 mt-2">
                        ...
                        <div class="grid grid-cols-12 w-full justify-around items-center py-3 gap-3 ">
                            <p class="col-span-3  text-[red]  text-xl">Số tiền từ</p>
                            <div class="col-span-3 mt-2">
