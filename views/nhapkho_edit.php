                    ...
                    <div class=" rounded-md   shadow-sm w-full">
                        ...
                        <div class=''>
                            <div class=" w-full gap-10 p-3">
                                <div class="w-full flex gap-5 tablet:grid tablet:grid-cols-12 tablet:gap-5  phone:grid phone:grid-cols-12 phone:gap-3">
                                    ...
                                    <label class="w-2/6 flex gap-4 phone:col-span-8 tablet:col-span-6 tablet:w-full phone:w-full uppercase tracking-wide text-white text-xs   whitespace-nowrap">
                                        <select id="nhacc_add" class="w-full appearance-none block   text-[white] border-b border-[#f568e3]  px-4 leading-tight focus:outline-none pb-2 bg-transparent text-[16px]" disabled>
                                    ...
                                    <label class="w-1/6 flex pl-8 gap-4 phone:col-span-4 phone:w-full tablet:col-span-3 tablet:w-full phone:px-0  uppercase tracking-wide text-white text-xs  whitespace-nowrap">
                                    ...
                                    <label class="w-1/6 flex pl-8 gap-3 phone:col-span-6 phone:w-full phone:px-0  tablet:col-span-3 tablet:w-full uppercase tracking-wide text-white text-xs items-end  whitespace-nowrap">
                                        <div id="ngay" data-date-format="dd/mm/yyyy" class="input-group date ">
                                            <input class="w-full appearance-none block   text-[white] border-b border-[#f568e3]  px-4 leading-tight focus:outline-none pb-2 bg-transparent text-[16px]" value="<?= date('d/m/Y'); ?>" id="ngayhd_add" data-date-format="dd/mm/yyyy" type="text" disabled>
                                            <span class="input-group-addon"></span>
                                        </div>
                                    </label>
                                    <label class="w-1/6 flex pl-8 gap-3 phone:col-span-6 phone:w-full phone:pl-0 tablet:pl-0  tablet:col-span-3 tablet:w-full items-center uppercase tracking-wide text-white text-xs  whitespace-nowrap">
                                        <div>
                                            <p class="text-[rgb(192,104,186)]">Tổng cộng</p>
                                        </div>
                                    ...
                                    <label class="w-1/6 flex pl-8 gap-3 phone:col-span-12 phone:w-full phone:px-0 phone:justify-end   tablet:col-span-3 tablet:w-full items-center uppercase tracking-wide text-white text-md  whitespace-nowrap">
        ...
        <div class="flex min-h-full justify-center p-4 text-center items-center sm:p-0">
            ...
            <div id="kichthuoc_form" class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full max-w-lg">
                    ...
                    <div class="p-4 w-full " data-te-modal-body-ref>
                        ...
                        <div class="w-full flex gap-5 pb-4">
                            ...
                            <div class="w-1/2 ">
                                ...
                                <input onkeyup="tinh_gianhapcothue_edit()" id="chietkhau_line_edit" class="w-full appearance-none block    border-b border-[#f568e3]  px-4 leading-tight focus:outline-none pb-2 bg-transparent text-[16px]">
                            </div>
                        </div>
                        <div class="w-full flex gap-5 pb-4">
                            ...
                            <div class="w-1/2 ">
                                <label>VAT</label>
                                <input id="vat_line_edit" onkeyup="tinh_gianhapcothue_edit()" value="1" class="w-full appearance-none block    border-b border-[#f568e3]  px-4 leading-tight focus:outline-none pb-2 bg-transparent text-[16px]" autocomplete="off">
                            </div>
                        </div>
                        <div class="w-full flex gap-5 pb-4">
                ...
                <div class="bg-gray-50 px-4 py-3 flex justify-end gap-3">
                    ...
                    <button type="button" onclick="edit_nhapkho_line()" class="mt-3 inline-flex w-full justify-center rounded-md bg-red-500 px-5 py-2 text-[14px]  text-white shadow-sm t ring-gray-300 hover:bg-[red]  sm:mt-0 max-w-[100px] ">Lưu</button>
                ...
                <div class="bg-white">
                    ...
                    <div class="p-4 " data-te-modal-body-ref>
                        <div class="w-full flex gap-5 pb-4">
                            ...
                            <input id="tennhacc_add" class="w-full appearance-none block border-b border-[#f568e3]  px-4 leading-tight focus:outline-none pb-2 bg-transparent text-[16px]">
                        </div>
                        <div>
                            <table class="min-w-full divide-y divide-gray-100 dark:divide-gray-200">
                                <thead>
...
<script>
    $(document).ready(async function() {
        await load_nhapkho_line()
        await load_nhacungcap()
