                        ...
                        <div class=''>
                            <div class=" w-full gap-10 p-3">
                                <div class="w-full flex gap-5 phone:grid phone:grid-cols-12 phone:gap-3">
                                    ...
                                    <label class="w-2/6 phone:w-full phone:pl-0 phone:col-span-8 flex pl-8 gap-3 items-center uppercase tracking-wide text-white text-xs  whitespace-nowrap">
                                        <div>
                                    ...
                                    <div class="flex gap-3 phone:w-full  phone:col-span-4 w-2/6 pl-8 items-center uppercase tracking-wide text-white text-md  whitespace-nowrap justify-end">
                        ...
                        <div class=" mb-4 w-full rounded-md flex gap-10 items-center tablet:grid tablet:grid-cols-12 tablet:gap-5  phone:grid phone:grid-cols-12 phone:gap-3">
                            ...
                            <div class="w-1/6 text-white tablet:w-full tablet:col-span-3 phone:w-full phone:col-span-4">
                                ...
                                <div id="ngay_handung" data-date-format="dd/mm/yyyy" class="input-group date ">
                                    <input id="handung_add" type="text" value="<?= date('d/m/Y'); ?>" data-date-format="dd/mm/yyyy" class="w-full appearance-none block   text-[white] border-b border-[#f568e3]  px-4 leading-tight focus:outline-none pb-2 bg-transparent text-[16px]" autocomplete="off">
                            ...
                            <div class="w-1/6 text-white tablet:w-full tablet:col-span-3 phone:w-full phone:col-span-3 tablet:flex tablet:items-end">
